...
export default {
  ...
  dashboard: {
    ...
    globalTags: 'Descripción global para cada imagen',
    imageDescription: 'Descripción de la imagen',
    intervalDesc: 'Generar una imagen cada x segundos',
    lostData: 'Todos los datos se perderán si actualizas esta página o cierras esta pestaña',
    noImages: 'Sube un video o imagen para comenzar',
